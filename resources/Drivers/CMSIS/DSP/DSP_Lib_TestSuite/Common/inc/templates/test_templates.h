 ...
 */
#define TEST_CONVERT_AND_ASSERT_SNR(ref_dst_ptr, ref_src_ptr, tst_dst_ptr, tst_src_ptr, block_size, tst_src_type, \
                                    threshold)                                                                    \
    do                                                                                                            \
    {                                                                                                             \
 ...
 *
 */
#define TEST_TEMPLATE_BUF1_BLK(arr_desc_inputs, arr_desc_block_sizes, input_type, output_type, fut, fut_arg_interface, \
 ...
 */
#define TEST_TEMPLATE_BUF1_ELT1(arr_desc_inputs, arr_desc_elts, input_type, elt_type, output_type, fut,             \
    ...
    {                                                                                                               \
        TEMPLATE_DO_ARR_DESC(                                                                                       \
            ...
            TEMPLATE_DO_ARR_DESC(elt_idx, elt_type, elt, arr_desc_elts, void *input_data_ptr = input_ptr->data_ptr; \
                                 TEST_CALL_FUT_AND_REF(fut, fut_arg_interface(input_data_ptr, elt), ref,            \
 ...
 *  parameter.
 */
#define TEST_TEMPLATE_BUF1_ELT1_BLK(arr_desc_inputs, arr_desc_elts, arr_desc_block_sizes, input_type, elt_type,     \
 ...
 *  parameter.
 */
#define TEST_TEMPLATE_BUF1_ELT2_BLK(arr_desc_inputs, arr_desc_elt1s, arr_desc_elt2s, arr_desc_block_sizes, input_type, \
                                    elt1_type, elt2_type, output_type, fut, fut_arg_interface, ref, ref_arg_interface, \
                                    compare_interface)                                                                 \
    do                                                                                                                 \
    {                                                                                                                  \
        TEMPLATE_DO_ARR_DESC(                                                                                          \
            ...
            TEMPLATE_DO_ARR_DESC(                                                                                      \
                ...
                TEMPLATE_DO_ARR_DESC(                                                                                  \
                    ...
                    TEMPLATE_DO_ARR_DESC(                                                                              \
                        elt2_idx, elt2_type, elt2, arr_desc_elt2s, void *input_data_ptr = input_ptr->data_ptr;         \
                        TEST_DO_VALID_BLOCKSIZE(                                                                       \
                            block_size, input_type, input_ptr,                                                         \
                            TEST_CALL_FUT_AND_REF(fut, fut_arg_interface(input_data_ptr, elt1, elt2, block_size), ref, \
 ...
 */
#define TEST_TEMPLATE_BUF2_BLK(arr_desc_inputs_a, arr_desc_inputs_b, arr_desc_block_sizes, input_type, output_type,  \
                               fut, fut_arg_interface, ref, ref_arg_interface, compare_interface)                    \
    do                                                                                                               \
    {                                                                                                                \
        ...
        TEMPLATE_DO_ARR_DESC(                                                                                        \
            ...
            TEMPLATE_DO_ARR_DESC(                                                                                    \
                block_size_idx, uint32_t, block_size, arr_desc_block_sizes, void *input_a_ptr = input_ptr->data_ptr; \
 ...
 */
#define TEST_TEMPLATE_ELT1(arr_desc_elts, elt_type, output_type, fut, fut_arg_interface, ref, ref_arg_interface, \
                           compare_interface)                                                                    \
    do                                                                                                           \
    {                                                                                                            \
        TEMPLATE_DO_ARR_DESC(                                                                                    \
            ...
            TEST_CALL_FUT_AND_REF(                                                                               \
                ...
                ref_arg_interface(                                                                               \
                    elt)); /* Comparison interfaces typically accept */ /* a block_size. Pass a dummy value 1.*/ \
 ...
 */
#define TEST_TEMPLATE_ELT2(arr_desc_elts_a, arr_desc_elts_b, elt_a_type, elt_b_type, output_type, fut,             \
                           fut_arg_interface, ref, ref_arg_interface, compare_interface)                           \
    do                                                                                                             \
    {                                                                                                              \
        TEMPLATE_DO_ARR_DESC(                                                                                      \
            ...
            TEST_CALL_FUT_AND_REF(                                                                                 \
                ...
                ref_arg_interface(                                                                                 \
                    elt_a,                                                                                         \
                    elt_b)); /* Comparison interfaces typically accept */ /* a block_size. Pass a dummy value 1.*/ \
            compare_interface(1, output_type));                                                                    \
        return JTEST_TEST_PASSED;                                                                                  \
    } while (0)
 ...
 */
#define TEST_TEMPLATE_ELT1_BLK(arr_desc_elts, arr_desc_block_sizes, elt_type, output_type, fut, fut_arg_interface,    \
                               ref, ref_arg_interface, compare_interface)                                             \
    do                                                                                                                \
    {                                                                                                                 \
        TEMPLATE_DO_ARR_DESC(block_size_idx, uint32_t, block_size, arr_desc_block_sizes,                              \
                             TEMPLATE_DO_ARR_DESC(elt_idx, elt_type, elt, arr_desc_elts,                              \
                                                  ...
                                                  TEST_CALL_FUT_AND_REF(fut, fut_arg_interface(elt, block_size), ref, \
